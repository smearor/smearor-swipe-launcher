...
/// Widget-level tool actions for the notifications widget, invoked via `InvokeToolMessage`.
///
/// These actions control view switching between Compact and Expanded views.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NotificationWidgetAction {
...
impl AsRef<str> for NotificationWidgetAction {
    fn as_ref(&self) -> &str {
        match self {
            Self::Expand => "expand",
...
impl FromStr for NotificationWidgetAction {
...
impl Display for NotificationWidgetAction {
