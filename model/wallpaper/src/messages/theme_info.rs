...
impl WallpaperThemeInfo {
    /// Creates a new theme info from name, description, preview path and type.
    pub fn new(name: &str, description: &str, preview_image_path: &str, wallpaper_type: WallpaperType) -> Self {
        Self {
            name: name.into(),
