//! Shared message types for dynamic launcher instance load/stop operations.
//!
//! Plugins and services use these messages to request the creation or
//! termination of launcher instances at runtime via the message broker.
...
pub use lifecycle_event::InstanceLifecycleEvent;
