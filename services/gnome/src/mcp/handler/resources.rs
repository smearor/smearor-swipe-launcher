...
impl McpResourceHandler<CompositorMcpResources> for GnomeWorkspaceService {
...
impl MessageHandler<FfiEnvelopePayload<InvokeResourceMessage>> for GnomeWorkspaceService {
