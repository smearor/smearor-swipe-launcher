...
--audio-set-media-role Flag (default: no)
...
--background-blur-radius Float (default: 16)
...
--border-background Choices: none color tiles blur (default: color)
...
--cdda-span-a Integer (default: 0) [deprecated]
--cdda-span-b Integer (default: 0) [deprecated]
...
--clipboard-backends Object settings list (default: win32,mac,wayland,x11,vo)
...
--clipboard-xwayland Flag (default: no)
...
--cscale Choices:  bilinear bicubic_fast oversample spline16 spline36 spline64 sinc lanczos ginseng bicubic hermite catmull_rom mitchell robidoux robidouxsharp
box nearest triangle gaussian jinc ewa_lanczos ewa_hanning ewa_ginseng ewa_lanczossharp ewa_lanczos4sharpest ewa_lanczossoft haasnsoft ewa_robidoux
ewa_robidouxsharp bartlett cosine hanning tukey hamming quadric welch kaiser blackman sphinx (default: )
...
--demuxer-rawaudio-format Choices: u8 s8 u16le u16be s16le s16be u24le u24be s24le s24be u32le u32be s32le s32be floatle floatbe doublele doublebe u16 s16 u24
s24 u32 s32 float double (default: s16le)
...
--display-tags String list (default:
Artist,Album,Album_Artist,Comment,Composer,Date,Description,Genre,Performer,Rating,Series,Title,Track,icy-title,service_name,Uploader,Channel_URL)
--display-tags-add
--display-tags-append
--display-tags-clr
--display-tags-del
...
--dscale Choices:  bilinear bicubic_fast oversample spline16 spline36 spline64 sinc lanczos ginseng bicubic hermite catmull_rom mitchell robidoux robidouxsharp
box nearest triangle gaussian jinc ewa_lanczos ewa_hanning ewa_ginseng ewa_lanczossharp ewa_lanczos4sharpest ewa_lanczossoft haasnsoft ewa_robidoux
ewa_robidouxsharp bartlett cosine hanning tukey hamming quadric welch kaiser blackman sphinx (default: hermite)
...
--dvbin-timeout Float (0 to 3.4028234663853e+38) (default: 30)
...
--hdr-reference-white Choices: auto (or an integer) (10 to 10000) (default: auto)
...
--hwdec-toggle
--hwdec-remove
--hwdec-codecs String (default: h264,vc1,hevc,vp8,vp9,av1,prores,prores_raw,ffv1,dpx)
...
--load-context-menu Flag (default: yes)
...
--scale Choices: bilinear bicubic_fast oversample spline16 spline36 spline64 sinc lanczos ginseng bicubic hermite catmull_rom mitchell robidoux robidouxsharp
box nearest triangle gaussian jinc ewa_lanczos ewa_hanning ewa_ginseng ewa_lanczossharp ewa_lanczos4sharpest ewa_lanczossoft haasnsoft ewa_robidoux
ewa_robidouxsharp bartlett cosine hanning tukey hamming quadric welch kaiser blackman sphinx (default: lanczos)
...
--scripts-toggle
--scripts-remove
--sdr-adjust-gamma Choices: auto yes no (default: auto)
...
--sub-fix-timing-keep Integer (default: 400)
--sub-fix-timing-threshold Integer (default: 210)
...
--swapchain-depth Integer (1 to 8) (default: 2)
...
--target-colorspace-hint-strict Flag (default: yes)
--target-contrast Choices: auto inf (or an integer) (10 to 10000000) (default: auto)
--target-gamut Choices: auto bt.601-525 bt.601-625 bt.709 bt.2020 bt.470m apple adobe prophoto cie1931 dci-p3 display-p3 v-gamut s-gamut ebu3213 film-c aces-ap0
aces-ap1 (default: auto)
--target-lut String (default: ) [file]
--target-peak Choices: auto (or an integer) (10 to 10000) (default: auto)
--target-prim Choices: auto bt.601-525 bt.601-625 bt.709 bt.2020 bt.470m apple adobe prophoto cie1931 dci-p3 display-p3 v-gamut s-gamut ebu3213 film-c aces-ap0
aces-ap1 (default: auto)
...
--treat-srgb-as-power22 Choices: no input output both auto (default: auto)
--tscale Choices: oversample linear spline16 spline36 spline64 sinc lanczos ginseng bicubic hermite catmull_rom mitchell robidoux robidouxsharp box nearest
triangle gaussian bartlett cosine hanning tukey hamming quadric welch kaiser blackman sphinx jinc (default: oversample)
...
--video-exts String list (default: 3g2,3gp,avi,flv,ivf,m2ts,m4v,mj2,mkv,mov,mp4,mpeg,mpg,mxf,ogv,rmvb,ts,webm,wmv,y4m)
--video-exts-add
--video-exts-append
--video-exts-clr
--video-exts-del
...
--video-sync Choices: audio display-resample display-resample-vdrop display-resample-desync display-tempo display-adrop display-vdrop display-desync desync (
default: audio)
...
--wayland-disable-vsync Flag (default: no) [deprecated]
...
--wayland-internal-vsync Choices: no auto yes (default: auto)
