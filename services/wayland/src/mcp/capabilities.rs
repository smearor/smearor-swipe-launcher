...
impl McpCapabilitiesRegistrator for WaylandWorkspaceService {
    fn register_mcp_capabilities(&self) {
        ...
        let workspaces_resource = RegisterResourceMessage::new(
            ...
            "Workspace Snapshot",
            "Current Wayland workspace layout: all workspaces with names, active state, and monitor assignment.",
            "application/json",
        );
