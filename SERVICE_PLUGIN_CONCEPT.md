...
pub struct ServiceVTable {
    ...
    pub get_id: unsafe extern "C" fn(service: *mut ()) -> stabby::string::String,
    pub get_display_name: unsafe extern "C" fn(service: *mut ()) -> stabby::string::String,
...
) -> stabby::result::Result<LoadedService, stabby::string::String>;
```
