...
impl McpCapabilitiesRegistrator for NetworkWidget {
    fn register_mcp_capabilities(&self) {
        ...
        let button_tool = RegisterToolMessage::new(&button_tool_name, "Trigger an action on the network widget (view switching or input action).", &schema);
