...
use crate::uptime::config::UptimeDisplayMode;
use crate::uptime::config::UptimeWidgetConfig;
...
pub struct UptimeWidget {
    ...
    pub latest_status: Rc<RefCell<Option<UptimeStatusMessage>>>,
...
impl MessageHandler<FfiEnvelopePayload<PersonalizationStatusMessage>> for UptimeWidget {
...
impl AcceptTopic<FfiEnvelope> for UptimeWidget {
    fn accept_topic(&self, topic: &str) -> bool {
        topic == TOPIC_UPTIME || topic == <FfiEnvelopePayload<PersonalizationStatusMessage> as MessageTopic>::topic()
    }
}
...
impl WidgetPlugin for UptimeWidget {
