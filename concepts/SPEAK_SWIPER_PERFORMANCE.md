...
/// Maximum tokens before context shifting
...
**Date**: 2026-07-14
**Hardware**: Ryzen 9 9950X3D + RX 7900 XTX (24GB VRAM)
**Models**: Qwen2.5-1.5B-Instruct (Q4_K_M), Whisper Large-v3-Turbo (Q5_0), BGE-Small-EN-v1.5-Q
**Backend**: Vulkan with HIPBLAS (AMD ROCm)
