...
Dieses Konzept für die Plugin-Architektur des *Smearor Swipe Launchers* setzt auf die ABI-Stabilität des Rust-Crates und eine klare Trennung zwischen Widget-UI
(Rendering) und Logik (Backend-Anbindung an D-Bus/System-APIs).
