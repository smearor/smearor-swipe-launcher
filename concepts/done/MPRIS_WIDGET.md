...
This document describes the architecture for the **MPRIS Widget Plugin** and **MPRIS Service Plugin** of the *Smearor Swipe Launcher*. The system uses the D-Bus
MPRIS standard (`org.mpris.MediaPlayer2`) to control and display information from media players like Spotify, VLC, Firefox, etc.
